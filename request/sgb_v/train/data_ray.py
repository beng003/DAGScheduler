...
path = "/disc/home/beng003/work/DAGScheduler/JobConfig/sgbv/train/ray_sgv_bob_ip4.yaml"
write_yaml("./request/sgb_v/train/bob_request_data_ip4.yaml",data_generate(path))
