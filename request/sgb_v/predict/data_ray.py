...
path = "/disc/home/beng003/work/DAGScheduler/JobConfig/sgbv/predict/ray_sgv_alice_ip4.yaml"
write_yaml("./request/sgb_v/predict/alice_request_data_ip4.yaml",data_generate(path))

path = "/disc/home/beng003/work/DAGScheduler/JobConfig/sgbv/predict/ray_sgv_bob_ip4.yaml"
write_yaml("./request/sgb_v/predict/bob_request_data_ip4.yaml",data_generate(path))
